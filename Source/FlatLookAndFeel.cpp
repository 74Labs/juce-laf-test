...
void FlatLookAndFeel::drawRotarySlider(Graphics &g, int x, int y, int width, int height,
	float sliderPosProportional, float rotaryStartAngle, float rotaryEndAngle, Slider &slider)
{
	...
	*/
	...
	g.drawImage(myStrip, (int)rx, (int)ry, 2 * (int)radius, 2 * (int)radius,   //Dest
...
//==============================================================================
void FlatLookAndFeel::drawButtonBackground(Graphics& g, Button& button, const Colour& backgroundColour, bool isMouseOverButton, bool isButtonDown)
{
	const int width = button.getWidth();
	const int height = button.getHeight();

	const float indent = 2.0f;
	const int cornerSize = 2; // jmin(roundToInt(width * 0.4f), roundToInt(height * 0.4f));
	...
	//g.strokePath(p, PathStrokeType((isMouseOverButton) ? 1.5f : 0.5f));
}

void FlatLookAndFeel::drawTickBox(Graphics& g, Component& component, float x, float y, float w, float h, 
	const bool ticked, const bool isEnabled, const bool isMouseOverButton, const bool isButtonDown)
{
	Path box;
	box.addRoundedRectangle(0.0f, 2.0f, 6.0f, 6.0f, 1.0f);

	g.setColour(isEnabled ? Colours::blue.withAlpha(isButtonDown ? 0.3f : 0.1f) : Colours::lightgrey.withAlpha(0.1f));
...
void FlatLookAndFeel::drawToggleButton(Graphics& g, ToggleButton& button, bool isMouseOverButton, bool isButtonDown)
{
...
void FlatLookAndFeel::drawProgressBar(Graphics& g, ProgressBar& progressBar, int width, int height, double progress, const String& textToShow)
{
...
void FlatLookAndFeel::drawScrollbarButton(Graphics& g,
	ScrollBar& bar,
...
void FlatLookAndFeel::drawScrollbar(Graphics& g,
	ScrollBar& bar,
	int x, int y,
	int width, int height,
	bool isScrollbarVertical,
...
ImageEffectFilter* FlatLookAndFeel::getScrollbarEffect()
{
...
//==============================================================================
void FlatLookAndFeel::drawPopupMenuBackground(Graphics& g, int width, int height)
{
...
void FlatLookAndFeel::drawMenuBarBackground(Graphics& g, int /*width*/, int /*height*/,
...
//==============================================================================
void FlatLookAndFeel::drawTextEditorOutline(Graphics& g, int width, int height, TextEditor& textEditor)
{
...
//==============================================================================
void FlatLookAndFeel::drawComboBox(Graphics& g, int width, int height,
...
//const Font FlatLookAndFeel::getComboBoxFont (ComboBox& box)
//{
...
void FlatLookAndFeel::drawLinearSlider(Graphics& g,
int x, int y,
int w, int h,
float sliderPos,
float minSliderPos,
...
Button* FlatLookAndFeel::createSliderButton(const bool isIncrement)
{
	if (isIncrement)
...
ImageEffectFilter* FlatLookAndFeel::getSliderEffect()
{
	return &scrollbarShadow;
}

int FlatLookAndFeel::getSliderThumbRadius(Slider&)
{
	return 8;
}

//==============================================================================
void FlatLookAndFeel::drawCornerResizer(Graphics& g,
	int w, int h,
	bool isMouseOver,
...
//==============================================================================
Button* FlatLookAndFeel::createDocumentWindowButton(int buttonType)
{
	Path shape;
...
void FlatLookAndFeel::positionDocumentWindowButtons(DocumentWindow&,
	int titleBarX,
	int titleBarY,
	int titleBarW,
	int titleBarH,
